...
import "./Eth_PoolManagerStorage.sol";

contract EthPoolManager is
    Initializable,
    OwnableUpgradeable,
    ...
    PoolManagerStorage
{
    ...
    function withdrawEthFromBridge(
        ...
        emit WithdrawEth(msg.sender, withdrawAddress, amount);
        return true;
    }
    ...
    function getEthPoolBalance() public view returns (uint256) {
