...
/// @title USDT Token (ERC20) for RootHashChain
/// @notice Simple ERC20 with owner-controlled minting and token burning
contract USDTToken is ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable {
    ...
    function recoverERC20(address token, uint256 amount, address to) external onlyOwner {
        require(token != address(this), "Cannot recover native USDT tokens");
